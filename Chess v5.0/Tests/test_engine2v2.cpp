...
//g++ -o test_engine.exe test_engine2.cpp ../src/Engine/ChessEngine.cpp ../src/Board/ChessBoard.cpp ../src/Engine/TranspositionTables.cpp ../src/Other/GlobalVariables.cpp ../src/Pieces/ChessPiece.cpp -std=c++20 -ljsoncpp
